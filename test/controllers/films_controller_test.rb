...
class FilmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create film" do
    assert_difference("Film.count") do
      post films_url, params: { film: { rating: @film.rating, title: @film.title, type: @film.type } }
    end
  ...
  test "should update film" do
    patch film_url(@film), params: { film: { rating: @film.rating, title: @film.title, type: @film.type } }
